...
function EquipTable({ tableData, setTableData, models, equipName, setEquipName}) {
...
/*	console.log("items models ", models)*/
	...
	const handleChange = event => {
    	setEquipName(event.target.value);
  	};				
	...
	return(
		<div>
			<div className="flex flex-row mt-16">
	            ...
	            <input name="EquipmentName" className="min-w-max ml-1 whitespace-nowrap w-52 text-left text-pata-400 text-xl bg-transparent  placeholder:text-pata-400" value={equipName} onChange={handleChange} type="text" placeholder="My Equipment1"/>
	        </div>
	        <Divider />
